defmodule ExMon do
  ...
  # utilizando o padrão facade - para simplificar a chamada, delegando o funcionamento para outro módulo
  # toda vez que ExMon.create_trainer(params) for chamado, a funcao sera delegada para
